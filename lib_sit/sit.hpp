...
namespace sit {
    ...
    typedef myUnit< 1, 0, 0> Metre;
    typedef myUnit< 0, 0, 1> Second;
    typedef myUnit< 0, 1, 0> Kilogram;
                        
    typedef myUnit< 2, 0, 0> Metre2;
    typedef myUnit< 0, 0, 2> Second2;
    typedef myUnit< 0, 2, 0> Kilogram2;
                        
    typedef myUnit< 3, 0, 0> Metre3;
    typedef myUnit< 0, 0, 3> Second3;
    typedef myUnit< 0, 3, 0> Kilogram3;
                        
    // Base units and their exp variants as symbols:
    typedef myUnit< 1, 0, 0> m;
    typedef myUnit< 0, 0, 1> s;
    typedef myUnit< 0, 1, 0> kg;
