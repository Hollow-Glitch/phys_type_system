...
#include <iostream>
//#include <filesystem> // only with c++17 or later
#include <string>
#include <memory>
#include <limits>
#include <typeinfo>
...
int main() {
    ...
    print(" - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n");
    {
        ...
        // _i_ ... interaction with double *, *=, /, /=
        // _I_ ... interaction with Integers
        ...
        //>> number  : +,-,*,/
        auto var_1 = num1 * num2;

        //>> {Unit} interaction with {Unit}   : +,-,*,/
        auto res_a_1 = val1 + val2;
        auto res_a_2 = val1 - val2;
        auto res_a_3 = val1 * val2;
        auto res_a_4 = val1 / val2;

        //>> {Unit} interaction with {double}   : +,-,*,/
        Metre_t res_i_1 = foo1 * val1;
        Metre_t res_i_2 = val1 * foo1;
        auto    res_i_3 = foo1 / val1; // perMetre  i.e.:  [m^-1]
        Metre_t res_i_4 = val1 / foo1;
        Metre_t res_i_5 = val1;
        Metre_t res_i_6 = val1;
        res_i_5 *= foo1;
        res_i_6 /= foo1;

        //>> {Unit} interaction with {int}   : +,-,*,/
        Metre_t res_I_1 = bar1 * val1;
        Metre_t res_I_2 = val1 * bar1;
        auto    res_I_3 = bar1 / val1; // perMetre  i.e.:  [m^-1]
        Metre_t res_I_4 = val1 / bar1;
        Metre_t res_I_5 = val1;
        Metre_t res_I_6 = val1;
        res_I_5 *= bar1;
        res_I_6 /= bar1;
        ...
        //>> with units   : <,>,<=,>=,==,!=     interaction-internal
        ...
        //=== copy assignment   interaction-internal
        //>> with units
        //>> with doubles
